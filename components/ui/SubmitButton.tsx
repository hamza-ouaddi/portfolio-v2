...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="group relative flex items-center justify-center gap-2 h-[calc(48px+8px)] overflow-hidden rounded-full transition-all  w-fit focus:scale-[1.15] hover:scale-[1.10] text-white dark:text-white bg-gray-900 dark:bg-white/10 px-8 py-2"
    >
      {pending ? (
